  ...
  _.forEach(trials, trial => {
    ...
    let stimulus = `
        ...
        <script>
            ...
            barCtx.roundRect(0, 0, barCanvas.width*${trial_number /
              num_trials}, barCanvas.height, 20).fill();
        </script>
        <h5 style="text-align:center;">Trial ${trial_number} of ${num_trials}</h5>
        <div style="width:100%;">
            <div style="width:50%;text-align:center;float:left;">
                <img src="stims/${trial.pic1}.jpg" alt="${
      trial.pic1
    }" height="200px" align="middle" style="max-width:400px;"/> 
            </div>
            <div style="width:50%;text-align:center;float:left;">
                <img src="stims/${trial.pic2}.jpg" alt="${
      trial.pic2
    }" height="200px" align="middle" style="max-width:400px;width=50%;" />
            </div>
        </div>
        `;
